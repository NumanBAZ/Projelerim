...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Sequential(
            ...
            nn.Dropout(0.5)  # Dropout ekledim overfitting'i önlemek için
        )
...
optimizer = torch.optim.Adam(model.parameters(), lr=0.0001)  # Öğrenme oranını düşürdüm
